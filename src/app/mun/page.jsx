  ...
  return (
    <div className={`${raleway.className} min-h-screen bg-black relative overflow-hidden`}>
      ...
      <div className="relative z-10 container mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="text-4xl font-bold text-red-500 mb-2 sm:text-5xl">Model United Nations </h1>
          <p className="max-w-2xl mx-auto mt-5 text-gray-300">
            Engaging in diplomatic simulations, fostering international cooperation, and developing global perspectives through structured debate.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="max-w-2xl mx-auto mt-5 text-gray-300">
            Passionate individuals dedicated to promoting diplomatic discourse and international relations.
          </p>
        </motion.div>
